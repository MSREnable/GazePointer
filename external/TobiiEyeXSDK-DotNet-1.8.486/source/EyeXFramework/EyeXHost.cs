...
namespace EyeXFramework
{
    ...
    public partial class EyeXHost : IDisposable
    {
        ...
        private readonly EngineStateAccessor<EyeTrackingConfigurationStatus> _configurationStatus; 
        ...
        public EyeXHost()
        {
            ...
            _configurationStatus = new EngineStateAccessor<EyeTrackingConfigurationStatus>(StatePaths.ConfigurationStatus);
        ...
        /// <summary>
        /// Event raised when configuration status has changed
        /// </summary>
        public event EventHandler<EngineStateValue<EyeTrackingConfigurationStatus>> ConfigurationStatusChanged
        {
            add { _configurationStatus.Changed += value; }
            remove { _configurationStatus.Changed -= value; }
        }
        ...
        /// <summary>
        /// Gets the engine state: Configuraton status
        /// </summary>
        public EngineStateValue<EyeTrackingConfigurationStatus> ConfigurationStatus
        {
            get { return _configurationStatus.GetCurrentValue(); }
        }
        ...
        public virtual void Start()
        {
            ...
            _configurationStatus.OnContextCreated(_context);
        ...
        protected virtual void OnConnectionStateChanged(object sender, ConnectionStateChangedEventArgs e)
        {
            ...
            if (e.State == ConnectionState.Connected)
            {
                ...
                _configurationStatus.OnConnected(_context);
            ...
            else
            {
                ...
                _configurationStatus.OnDisconnected();
